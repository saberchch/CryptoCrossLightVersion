...
export default function SiteHeader() {
  ...
  // Hide global header on dashboard-like pages
  if (
  ...
  return (
    <header className="site-header flex items-center justify-between px-8 py-4 w-full">
      {/* Logo */}
      <div className="flex items-center gap-4 text-white">
        <div className="size-8 text-[#f4c025]">
        ...
        <h2 className="text-white text-xl font-bold leading-tight tracking-[-0.015em]">CryptoCross</h2>
      </div>
      ...
      <div className="flex items-center gap-3">
        {!user ? (
          <a href="/login" className="dropdown-button">
